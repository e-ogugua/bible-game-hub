...
export const quizQuestions: QuizQuestion[] = [
  // Easy Questions
  {
    ...
    correct: 1,
    explanation: "Noah built the ark as commanded by God to save his family and animals from the flood.",
  ...
  // Medium Questions
  {
    ...
    options: ["7", "14", "21", "40"],
    correct: 3,
    explanation: "Jesus fasted for 40 days and nights in the wilderness before beginning His ministry.",
  ...
  },
  {
    ...
    correct: 2,
    explanation: "Sarah was Abraham's wife, originally named Sarai, and mother of Isaac.",
  ...
  },
  {
    ...
    options: ["5", "7", "10", "12"],
    correct: 1,
    explanation: "The Book of Revelation describes seven seals that are opened during the end times.",
  ...
  },
  {
    ...
    correct: 2,
    explanation: "Methuselah lived to be 969 years old, making him the oldest person in the Bible.",
  ...
  },
  {
    ...
    options: ["Frogs", "Water turned to blood", "Darkness", "Death of firstborn"],
    correct: 1,
    explanation: "The first plague was turning the Nile River and all water in Egypt to blood.",
  ...
  // Genesis Questions - Medium
  {
    ...
    correct: 2,
    explanation: "Abraham was 100 years old when his son Isaac was born to Sarah.",
  ...
  // Proverbs Questions - Easy
  {
    ...
    correct: 1,
    explanation: "This verse is from Proverbs 3:5, a book of wisdom literature.",
  ...
  // New Testament - Easy
  {
    ...
    options: ["25", "26", "27", "28"],
    correct: 2,
    explanation: "The New Testament contains 27 books written after Jesus' life.",
    reference: "Various",
    difficulty: 'easy'
  },
  ...
  // Hard Questions
  {
    ...
    correct: 3,
    explanation: "Matthew was a tax collector who became one of Jesus' twelve apostles.",
  ...
  },
  {
    ...
    options: ["Garden of Eden", "Gethsemane", "Garden of Olives", "Garden of Golgotha"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Lydia", "Cornelius", "The Ethiopian eunuch", "Simon the sorcerer"],
    correct: 1,
    explanation: "Cornelius, a Roman centurion, was the first Gentile convert through Peter's ministry.",
  ...
  // Exodus Questions - Medium
  {
    ...
    options: ["8", "9", "10", "12"],
    correct: 2,
    explanation: "God sent 10 plagues upon Egypt to convince Pharaoh to let the Israelites go.",
  ...
  // Daniel Questions - Hard
  {
    ...
    options: ["60", "65", "70", "75"],
    correct: 2,
    explanation: "Daniel's prophecy mentions 70 weeks (490 years) for God's plan.",
  ...
  // More Genesis Questions - Medium
  {
    ...
    correct: 1,
    explanation: "Esau was called Edom (meaning red) because he was red and hairy at birth.",
  ...
  // Exodus Questions - Hard
  {
    ...
    correct: 2,
    explanation: "Moses died at age 120, just before entering the Promised Land.",
  ...
  {
    id: 38,
    question: "Which Psalm contains the verse 'The fool says in his heart, there is no God'?",
    options: ["Psalm 14", "Psalm 51", "Psalm 91", "Psalm 119"],
    correct: 0,
    explanation: "Psalm 14:1 says 'The fool says in his heart, there is no God.'",
  ...
  // More Gospel Questions - Hard
  {
    ...
    correct: 1,
    explanation: "Caiaphas was the high priest who questioned Jesus before His crucifixion.",
  ...
  // Old Testament Books - Medium
  {
    ...
    options: ["35", "37", "39", "41"],
    correct: 2,
    explanation: "The Old Testament contains 39 books, written before Jesus' time.",
    reference: "Various",
    difficulty: 'medium'
  }
];
