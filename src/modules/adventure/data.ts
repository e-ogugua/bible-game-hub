...
export const adventureData: AdventureData = {
  ...
  'moses-1': {
    ...
    narrative: 'You are Moses, raised in Pharaoh\'s palace but aware of your Hebrew heritage. The oppression of your people weighs heavily on your heart.',
    ...
    choices: [
      {
        ...
        consequence: 'Your act of justice leads to conflict, forcing you to flee Egypt.',
        scoreImpact: 10,
        nextStage: 'moses-2'
      },
      {
        text: 'Seek counsel from the palace advisors',
        consequence: 'You gain wisdom but delay action, missing an opportunity to help.',
        scoreImpact: -5,
        nextStage: 'moses-2'
      },
      {
  ...
  'moses-2': {
    ...
    narrative: 'Now a shepherd in Midian, you\'ve found peace but still feel called to something greater. One day, you encounter a burning bush that is not consumed.',
    backgroundImage: '/images/desert-mountain.jpg',
    characterImage: '/images/moses-shepherd.jpg',
    choices: [
      {
        text: 'Approach the bush cautiously',
        consequence: 'You hear God\'s voice calling you to lead your people out of Egypt.',
        scoreImpact: 20,
        nextStage: 'moses-3'
      },
      {
  ...
  'moses-3': {
    ...
    narrative: 'God speaks to you from the burning bush, revealing His name and commissioning you to free the Israelites.',
  ...
  'david-1': {
    ...
    narrative: 'You are David, the youngest son of Jesse, tending sheep in the hills of Bethlehem. Your brothers are at war with the Philistines.',
  ...
  'david-2': {
    ...
    narrative: 'The Philistine giant Goliath taunts the Israelite army. Your father sends you to deliver food to your brothers.',
    ...
    choices: [
      {
        ...
        consequence: 'You step forward, trusting in divine strength over human might.',
        scoreImpact: 25,
        nextStage: 'david-3'
      },
      {
        text: 'Suggest seeking a diplomatic solution',
        consequence: 'Peace is considered, but Goliath\'s challenge demands action.',
        scoreImpact: 5,
        nextStage: 'david-3'
      }
    ]
  ...
  'david-3': {
    ...
    narrative: 'Armed only with a sling and stones, you face the giant. "The Lord who delivered me from the paw of the lion and the paw of the bear will deliver me from the hand of this Philistine."',
  ...
  'jesus-1': {
    ...
    narrative: 'You are Jesus, baptized by John in the Jordan River. The heavens open, and God\'s voice declares you His beloved Son.',
    ...
    choices: [
      {
        ...
        consequence: 'You are led by the Spirit into the wilderness for preparation.',
        scoreImpact: 10,
        nextStage: 'jesus-2'
      },
      {
  ...
  'jesus-2': {
    ...
    narrative: 'In the wilderness, Satan tempts you to turn stones into bread after 40 days of fasting.',
  ...
  'jesus-3': {
    ...
    narrative: 'Satan takes you to the pinnacle of the temple, tempting you to test God\'s protection.',
...
export const getStartingStage = (character: 'moses' | 'david' | 'jesus'): string => {
  switch (character) {
    case 'moses': return 'moses-1';
    case 'david': return 'david-1';
    case 'jesus': return 'jesus-1';
    default: return 'moses-1';
  }
};
